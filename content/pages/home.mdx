...
blocks:
  - title: Decentralized Content Publishing
    description: A mdx cms content editor that can grow by stacking fancy blocks.
    actions:
      - label: Get Started
        type: button
        icon:
  ...
  - background: bg-default
    headline: Flat Content Storage
    tagline: A simple way to support long lasting content management.
    actions:
      - label: Get Started
        type: button
        icon:
      ...
      - label: Read Blog
        ...
        link: /posts
    image:
      src: /uploads/posts/complete-BCBFF633-E98D-4C85-AB7C-E65888A9594C.png
      alt: A diverse family of content components.
      videoUrl: ''
    _template: hero
  ...
  - title: 'Build by makers, loved by thousand developers'
    ...
    testimonials:
      - quote: I want the minimum now.
        author: The Minimum
        role: The Minimum
        avatar: /uploads/posts/complete-BCBFF633-E98D-4C85-AB7C-E65888A9594C.png
      - quote: >-
